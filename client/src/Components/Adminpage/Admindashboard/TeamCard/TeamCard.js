...
const TeamCard = ({ member }) => {
    ...
    return (
        <div className="member__card flex__center flex__flow__down">
            <img src={image} alt="member" className="member__image"></img>
            <h2>{name}</h2>
            <h3>{designation}</h3>
            <p>{tagline}</p>
            ...
            <div className="member__modify__section flex__center">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#fff" viewBox="0 0 24 24" ><path fill="#fff" d="M15 3C15.5523 3 16 3.44772 16 4L18 4C18.5523 4 19 4.44772 19 5C19 5.55229 18.5523 6 18 6L6 6C5.44772 6 5 5.55228 5 5C5 4.44772 5.44772 4 6 4L8 4C8 3.44772 8.44772 3 9 3H15Z" /><path fill="#fff" fillRule="evenodd" d="M6 7H18V19C18 20.1046 17.1046 21 16 21H8C6.89543 21 6 20.1046 6 19V7ZM9.5 9C9.22386 9 9 9.22386 9 9.5V18.5C9 18.7761 9.22386 19 9.5 19C9.77614 19 10 18.7761 10 18.5V9.5C10 9.22386 9.77614 9 9.5 9ZM14.5 9C14.2239 9 14 9.22386 14 9.5V18.5C14 18.7761 14.2239 19 14.5 19C14.7761 19 15 18.7761 15 18.5V9.5C15 9.22386 14.7761 9 14.5 9Z" clipRule="evenodd" /></svg>
            </div>
            {
                (popup) ? <EditMemberPopup name={name} image={image} designation={designation} tagline={tagline} linkedIn={linkedIn} github={github} setName={setName} setImage={setImage} setDesignation={setDesignation} setGithub={setGithub} setLinkedIn={setLinkedIn} setTagline={setTagline} setPopup={setPopup} /> : ''
            }
        </div>
    )
}

const EditMemberPopup = ({ name, image, designation, tagline, linkedIn, github, setName, setDesignation, setImage, setGithub, setLinkedIn, setTagline, setPopup }) => {
